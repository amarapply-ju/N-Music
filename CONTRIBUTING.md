...
This document defines the protocols for setting up the development environment, understanding the underlying technology stack, and compiling **N-Music** from the source.
...
The N-Music codebase is built on a modern, reactive architecture. Contributors are expected to have a high level of familiarity with:
...
N-Music follows a strict **Clean Architecture** approach. This separation of concerns ensures that the audio engine remains independent of the UI layer.
...
<div align="center">
<sub>N-Music: Engineering audio freedom.</sub>
</div>