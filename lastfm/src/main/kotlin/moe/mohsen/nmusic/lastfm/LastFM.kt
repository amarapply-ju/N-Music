...
package moe.mohsen.nmusic.lastfm

import moe.mohsen.nmusic.lastfm.models.Authentication
import moe.mohsen.nmusic.lastfm.models.LastFmError
import moe.mohsen.nmusic.lastfm.models.TokenResponse
...
object LastFM {
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        userAgent("ArchiveTune (https://github.com/alimohsenmaruf/N-Music)")
