...
import moe.mohsen.nmusic.constants.*
import moe.mohsen.nmusic.extensions.*
import moe.mohsen.nmusic.ui.screens.settings.ThemePalettes
import moe.mohsen.nmusic.ui.theme.ThemeSeedPalette
import moe.mohsen.nmusic.ui.theme.ThemeSeedPaletteCodec
...
import moe.mohsen.nmusic.utils.clearPlaybackWebAuthSession
import moe.mohsen.nmusic.utils.clearPlaybackAuthSession
import moe.mohsen.nmusic.innertube.YouTube
import moe.mohsen.nmusic.innertube.models.YouTubeLocale
import moe.mohsen.nmusic.kugou.KuGou
...
import moe.mohsen.nmusic.utils.toPlaybackAuthState
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Timber.plant(Timber.DebugTree())
        try {
            Timber.plant(moe.mohsen.nmusic.utils.GlobalLogTree())
        } catch (_: Exception) {}
