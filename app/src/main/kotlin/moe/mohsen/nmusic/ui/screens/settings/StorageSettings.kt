...
import moe.mohsen.nmusic.constants.MaxImageCacheSizeKey
...
import moe.mohsen.nmusic.extensions.tryOrNull
...
import moe.mohsen.nmusic.ui.player.CanvasArtworkPlaybackCache
import moe.mohsen.nmusic.ui.utils.backToMain
import moe.mohsen.nmusic.ui.utils.formatFileSize
    ...
    LaunchedEffect(maxImageCacheSize) {
        if (maxImageCacheSize == 0) {
            coroutineScope.launch(Dispatchers.IO) {
                ...
                moe.mohsen.nmusic.utils.ArtworkStorage.clear(context)
            }
        }
    }
