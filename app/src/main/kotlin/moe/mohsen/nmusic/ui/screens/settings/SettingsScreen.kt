...
import moe.mohsen.nmusic.ui.component.SettingsQuickActionsGrid
import moe.mohsen.nmusic.ui.component.NothingOSHeaderChipsRow
import moe.mohsen.nmusic.ui.component.NothingOSHeaderChip
...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        NothingOSBackground(modifier = Modifier.fillMaxSize()) {
            if (!showSearchBar) {
