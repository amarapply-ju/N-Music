...
-keep class moe.mohsen.nmusic.models.PersistQueue { *; }
-keep class moe.mohsen.nmusic.models.PersistPlayerState { *; }
-keep class moe.mohsen.nmusic.models.QueueData { *; }
-keep class moe.mohsen.nmusic.models.QueueType { *; }
-keep class moe.mohsen.nmusic.playback.queues.** { *; }
